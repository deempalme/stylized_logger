#ifndef RAMROD_CONSOLE_PRINTER_H
#define RAMROD_CONSOLE_PRINTER_H
...
namespace ramrod {
  namespace console {
     ...
     *
     */
      static void add_style(const int parameter = ramrod::console::color::style::reset);
     ...
     */
      static void colorize(const int color,
                           const int usage = ramrod::console::color::style::foreground);
      /*
     ...
     *
     */
      static void formatted(const char *format, const ramrod::message::message_type type, ...)
     ...
     */
      static void message(const std::string &text,
                          const ramrod::message::message_type type = ramrod::message::error);
    ...
    private:
      ...
      static void typify(const ramrod::message::message_type type);
...
#endif // RAMROD_CONSOLE_PRINTER_H
