...
namespace ramrod {
  ...
  extern console::regular regular;
   ...
   *
   */
  int formatted(const char *format, const ramrod::message::type type, ...)
  __attribute__((format (printf, 1, 3)));
  int formatted(const char *format, ...)  __attribute__((format (printf, 1, 2)));

  int printf(const char *format, const ramrod::message::type type, ...)
  __attribute__((format (printf, 1, 3)));
