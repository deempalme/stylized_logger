#ifndef RAMROD_LOG_WRITER_FILE_CERR_HPP
#define RAMROD_LOG_WRITER_FILE_CERR_HPP
...
{
/**
 * @brief Log output that writes messages to a file and the standard error stream.
 *
 * Writes all streamed content to a file and the standard error stream.
 */
class WriterFileCerr final : public Writer
{
public:
    /**
     * @brief Constructor.
     ...
     */
    WriterFileCerr(File& file);

    /**
     * @brief Clears the file and the standard error stream.
     */
    void clear() override;
    ...
    /**
     * @brief Writes the file and line information to the file and the standard error stream.
     *
     ...
     */
    WriterFileCerr& file_info(const char* file, const int line) override;

    /**
     * @brief Flushes the file and the standard error stream.
     */
    void flush() override;
     ...
     * @return Reference to current object.
     */
    WriterFileCerr& operator<<(const bool message) override;
     ...
     * @return Reference to current object.
     */
    WriterFileCerr& operator<<(const char message) override;
     ...
     * @return Reference to current object.
     */
    WriterFileCerr& operator<<(const unsigned char message) override;
     ...
     * @return Reference to current object.
     */
    WriterFileCerr& operator<<(const short message) override;
     ...
     * @return Reference to current object.
     */
    WriterFileCerr& operator<<(const unsigned short message) override;
     ...
     * @return Reference to current object.
     */
    WriterFileCerr& operator<<(const int message) override;
     ...
     * @return Reference to current object.
     */
    WriterFileCerr& operator<<(const unsigned int message) override;
     ...
     * @return Reference to current object.
     */
    WriterFileCerr& operator<<(const float message) override;
     ...
     * @return Reference to current object.
     */
    WriterFileCerr& operator<<(const long message) override;
     ...
     * @return Reference to current object.
     */
    WriterFileCerr& operator<<(const unsigned long message) override;
     ...
     * @return Reference to current object.
     */
    WriterFileCerr& operator<<(const double message) override;
     ...
     * @return Reference to current object.
     */
    WriterFileCerr& operator<<(const long double message) override;
     ...
     * @return Reference to current object.
     */
    WriterFileCerr& operator<<(const long long message) override;
     ...
     * @return Reference to current object.
     */
    WriterFileCerr& operator<<(const unsigned long long message) override;
     ...
     * @return Reference to current object.
     */
    WriterFileCerr& operator<<(const void* message) override;
     ...
     * @return Reference to current object.
     */
    WriterFileCerr& operator<<(const std::error_code& message) override;
     ...
     * @return Reference to current object.
     */
    WriterFileCerr& operator<<(const Endl& endl) override;
...
#endif // RAMROD_LOG_WRITER_FILE_CERR_HPP