...
namespace ramrod {
  namespace console {
    warning_stream::warning_stream() :
      ...
      format_("\033[0;1;38;5;229m")
    {}

    warning_stream &warning_stream::change_message(const std::string &new_message){
      message_ = "\033[1;30;48;5;11m" + new_message + "\033[0;1;38;5;229m ";
      return *this;
    }

    warning_stream &warning_stream::operator()(){
      std::cout << message_ << rr::format;
      return *this;
    }

    warning_stream &warning_stream::operator()(const std::string &text){
      std::cout << message_ << text << rr::format << std::endl;
      return *this;
    }

    warning_stream &warning_stream::operator()(const char *text){
      std::cout << message_ << text << rr::format << std::endl;
      return *this;
    }

    warning_stream &warning_stream::operator()(const bool boolean){
      std::cout << message_ << boolean << rr::format << std::endl;
      return *this;
    }

    warning_stream &warning_stream::operator()(const char character){
      std::cout << message_ << character << rr::format << std::endl;
      return *this;
    }

    warning_stream &warning_stream::operator()(const unsigned char character){
      std::cout << message_ << character << rr::format << std::endl;
      return *this;
    }

    warning_stream &warning_stream::operator()(const signed char character){
      std::cout << message_ << character << rr::format << std::endl;
      return *this;
    }

    warning_stream &warning_stream::operator()(const int integer_number){
      std::cout << message_ << integer_number << rr::format << std::endl;
      return *this;
    }

    warning_stream &warning_stream::operator()(const unsigned int unsigend_integer_number){
      std::cout << message_ << unsigend_integer_number << rr::format << std::endl;
      return *this;
    }

    warning_stream &warning_stream::operator()(const short short_integer_number){
      std::cout << message_ << short_integer_number << rr::format << std::endl;
      return *this;
    }

    warning_stream &warning_stream::operator()(const unsigned short unsigned_short_integer_number){
      std::cout << message_ << unsigned_short_integer_number << rr::format << std::endl;
      return *this;
    }

    warning_stream &warning_stream::operator()(const long long_integer_number){
      std::cout << message_ << long_integer_number << rr::format << std::endl;
      return *this;
    }

    warning_stream &warning_stream::operator()(const unsigned long unsigned_long_integer_number){
      std::cout << message_ << unsigned_long_integer_number << rr::format << std::endl;
      return *this;
    }

    warning_stream &warning_stream::operator()(const float float_number){
      std::cout << message_ << float_number << rr::format << std::endl;
      return *this;
    }

    warning_stream &warning_stream::operator()(const double double_number){
      std::cout << message_ << double_number << rr::format << std::endl;
      return *this;
    }

    warning_stream &warning_stream::operator()(const long double long_double_number){
    ...
    warning_stream &warning_stream::operator<<(const endl_stream &/*endls*/){
      std::cout << std::endl;
      return *this;
    }
  } // namespace: console
